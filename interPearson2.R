...
geneName1532 <- as.matrix(read.table("newSetTotal-1532-.csv",header=FALSE,sep=","))
#
...
similarity<-secSimilarity3210[geneName1532,geneName1532]
m=1
totalNum<-1532
#
thresh<-0.45
...
while(setNum>=endSetNum){
  ...
  dirName<-paste("pearson","iter",m,"factor",factor,"setNum",setNum,"totalNum",totalNum,"thresh",thresh,"threshNum",threshNum,sep="-")
  dir.create(dirName)
